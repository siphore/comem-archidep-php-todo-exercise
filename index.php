...
define('DB_USER', getenv('TODOLIST_BASE_URL') ?: 'todolist');
define('DB_PASS', getenv('TODOLIST_DB_PASS'));
define('DB_NAME', getenv('TODOLIST_BASE_URL') ?: 'todolist');
define('DB_HOST', getenv('TODOLIST_BASE_URL') ?: '127.0.0.1');
define('DB_PORT', getenv('TODOLIST_BASE_URL') ?: '3306');
// chAngeMeN0w!
...
if (isset($_POST['action'])) {
  switch($_POST['action']) {
    ...
    case 'toggle':
      ...
      $id = $_POST['id'];
      if(is_numeric($id)) {
        $updateQuery = 'UPDATE todo SET done = NOT done WHERE id = ' . $id; // Toggle the task's status
    ...
    case 'delete':
      ...
      $id = $_POST['id'];
      if(is_numeric($id)) {
        $deleteQuery = 'DELETE FROM todo WHERE id = ' . $id; // Delete the task
